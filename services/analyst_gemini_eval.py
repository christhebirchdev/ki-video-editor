...
def _user_message(result: AnalystResult, mode: str) -> str:
    ...
    if mode == "hybrid":
        return (
            ...
            "PFLICHT Untertitel (Regel im System-Prompt unter „Untertitel“): Laufen sie mit, beurteile "
            "sie IMMER und trag alles in den `untertitel`-Block — NICHT in schnitt_pacing oder "
            "visuelle_aesthetik. Laufen KEINE mit, obwohl gesprochen wird, ist das ein Mangel: "
            "`untertitel.vorhanden=false`, den Schritt baut das System.\n"
